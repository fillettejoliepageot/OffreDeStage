...
// Sur Render, des connexions peuvent être coupées (idle timeout, reboot, etc.).
// On loggue l'erreur mais on ne coupe pas le process : le pool recréera une connexion.
pool.on('error', (err) => {
